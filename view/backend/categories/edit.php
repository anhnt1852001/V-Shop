...
<!-- /.card-header -->
<?php
$cate = categories_get_one(['ma_mh'=>$_GET['id']]);
?>
      ...
      <div class="col-md-6">
        <div class="card card-primary">
          ...
          <div class="form-group">
              <label for="inputName">Mã Loại Hàng</label>
              <input name="ma_mh" class="form-control" readonly value="<?=$cate['ma_mh']?>">
            </div>
            <div class="form-group">
              <label for="inputName">Tên Loại</label>
              <input type="text" name="ten_mh" class="form-control" value="<?=$cate['ten_mh']?>">
